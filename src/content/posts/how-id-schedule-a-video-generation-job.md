...
[![Whiteboard for a Sora-like scheduler: requirements, job vs attempt, and a pull-based GPU pool with Postgres as the source of truth](/images/sora-architecture.png?v=2)](/images/sora-architecture.png?v=2)
